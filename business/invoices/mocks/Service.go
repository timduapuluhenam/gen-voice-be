...
func (_m *Service) CreateInvoiceDetail(invoiceDetailDomain *invoices.DatasDomain) (invoices.DatasDomain, error) {
...
func (_m *Service) DeleteInvoice(invoiceID int) (invoices.InvoiceDomain, error) {
...
func (_m *Service) GetAllByUserID(userID int) ([]invoices.InvoiceDetailDomain, error) {
...
func (_m *Service) GetAllEventByUserID(userID int) ([]invoices.InvoiceDomain, error) {
	ret := _m.Called(userID)
...
func (_m *Service) GetInvoiceDetailByID(id string) (invoices.InvoiceDetailDomain, error) {
	ret := _m.Called(id)
